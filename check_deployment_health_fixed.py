...
class DeploymentHealthChecker:
    ...
    async def check_rate_limit_status(self):
        """Check for recent rate limiting issues."""
        logger.info("🔍 Checking for rate limiting indicators...")
        
        try:
            # Check account activity patterns that might indicate rate limiting
